"""
Fix duplicate path segments in Cloudinary file paths.

Cloudinary files have paths like:
  myblog/travelogue/camino/ch8/myblog/travelogue/camino/ch8/IMG_xxx

Should be:
  myblog/travelogue/camino/ch8/IMG_xxx
...
def fix_path(public_id):
    ...
    # Look for pattern: myblog/travelogue/camino/ch8/myblog/...
    if len(parts) < 5:
...
def fix_all_paths(resource_type="image", folder="myblog/travelogue/camino/ch8", dry_run=True):
...
if __name__ == "__main__":
    ...
    # Fix images
    print("Fixing images...")
    fix_all_paths("image", "myblog/travelogue/camino/ch8", dry_run)
    
    # Fix videos
    print("\n\nFixing videos...")
    fix_all_paths("video", "myblog/travelogue/camino/ch8", dry_run)
