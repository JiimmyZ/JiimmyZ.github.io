...
class TestUploadWorkflow:
    ...
    def test_upload_workflow_complete(
        ...
        tmp_content_dir,
        sample_media_files,
        mock_cloudinary_upload_response,
    ):
        ...
        try:
            ...
            from media_processor import upload_file

            uploaded_count = 0
            for file_path in media_files[:2]:  # Upload first 2 files
                # find_media_files returns cwd-relative paths, and mapping keys are
                # POSIX-style paths below content/ (see upload_file)
                relative_path = file_path.relative_to("content").as_posix()
    ...
    def test_upload_workflow_skips_existing(
        ...
        # sample_mapping_file already lives at the project root (tmp_path)
        ...
        try:
            ...
            need_upload = [
                ...
                if f.relative_to("content").as_posix() not in existing_relative_paths
            ]
...
class TestMarkdownUpdateWorkflow:
    ...
    def test_markdown_update_workflow_complete(
        ...
        md_file.write_text(
            "![Image 1](IMG_001.jpg)\n![Image 2](IMG_002.png)", encoding="utf-8"
        )
    ...
    def test_markdown_update_workflow_with_backup(self, tmp_path, sample_mapping_file):
...
class TestDuplicateDetectionWorkflow:
    ...
    def test_duplicate_detection_workflow(
        ...
        from media_processor import find_duplicates, list_all_resources
