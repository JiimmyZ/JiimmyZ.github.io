...
class TestCheckStatus:
    ...
    def test_mapping_file_parsing(self, sample_mapping_file):
        ...
        files_with_urls = sum(
            1 for v in mapping.values() if isinstance(v, dict) and v.get("url")
        )
    ...
    @pytest.mark.unit
    def test_upload_status_comparison(
        self, tmp_content_dir, sample_media_files, sample_mapping_file
    ):
