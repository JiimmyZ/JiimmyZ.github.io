"""
Check if ch7 files in Cloudinary have duplicate path segments like ch8 did.
"""
...
def check_paths(resource_type="image", folder="myblog/travelogue/camino/ch7"):
    ...
    sample_files = [
        "myblog/travelogue/camino/ch7/IMG_20250621_073759",
        "myblog/travelogue/camino/ch7/IMG_20250621_124352",
        "myblog/travelogue/camino/ch7/IMG_20250621_133828",
    ]
...
if __name__ == "__main__":
    print("Checking ch7 images...")
    ch7_dup_images, ch7_correct_images = check_paths(
        "image", "myblog/travelogue/camino/ch7"
    )

    print("\n\nChecking ch7 videos...")
    ch7_dup_videos, ch7_correct_videos = check_paths(
        "video", "myblog/travelogue/camino/ch7"
    )
    ...
    print(
        f"Ch7 Videos - Duplicates: {len(ch7_dup_videos)}, Correct: {len(ch7_correct_videos)}"
    )

    # Compare with ch8
    print("\nChecking ch8 for comparison...")
    ch8_dup_images, ch8_correct_images = check_paths(
        "image", "myblog/travelogue/camino/ch8"
    )
    print(
        f"Ch8 Images - Duplicates: {len(ch8_dup_images)}, Correct: {len(ch8_correct_images)}"
    )
